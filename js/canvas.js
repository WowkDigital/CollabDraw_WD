import { createKonvaShape, updateKonvaShapeProperties, getDistanceToSegment } from './canvas-shapes.js';
...
export class CanvasManager {
  ...
  createKonvaShape(shapeId, shapeData) {
    return createKonvaShape(shapeId, shapeData);
  }
  ...
  getDistanceToSegment(px, py, x1, y1, x2, y2) {
    return getDistanceToSegment(px, py, x1, y1, x2, y2);
  }
  destroy() {
    this.stage.destroy();
    this.layers.clear();
